...
app.controller("NavController", ["$rootScope", "$scope", "$location", function($rootScope, $scope, $location) {
  ...
  $scope.items = [
    ...
    { modulo: "Cadastro", grupo: "Endereços", id: 'unidade_federacoes',       title: 'Unidades da Federação' },
    { modulo: "Cadastro", grupo: "Endereços", id: 'logradouro_tipos',         title: 'Tipos de Logradouro' },
    { modulo: "Cadastro", grupo: "Endereços", id: 'logradouro_titulos',       title: 'Títulos de logradouro' },
    ...
    { modulo: "Cadastro", grupo: "Clientes",  id: 'orgaos_expedidores_rg',    title: 'Órgãos Expedidores de RG' }
  ];
