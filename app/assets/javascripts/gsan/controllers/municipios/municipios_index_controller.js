...
app.controller("MunicipiosIndexController", ["UnidadeFederacao", "MicroRegiao", "RegiaoDesenvolvimento", "$scope", "$http", "CadastroUrl", function(UnidadeFederacao, MicroRegiao, RegiaoDesenvolvimento, $scope, $http, CadastroUrl) {
  $scope.query = {};
